...
func (_Token *TokenCaller) ChildChain(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "childChain")
...
//
// Solidity: function childChain() view returns(address)
func (_Token *TokenSession) ChildChain() (common.Address, error) {
	return _Token.Contract.ChildChain(&_Token.CallOpts)
}

// ChildChain is a free data retrieval call binding the contract method 0x42fc47fb.
//
// Solidity: function childChain() view returns(address)
func (_Token *TokenCallerSession) ChildChain() (common.Address, error) {
	return _Token.Contract.ChildChain(&_Token.CallOpts)
}
...
// ChangeChildChain is a paid mutator transaction binding the contract method 0xed9ef524.
//
// Solidity: function changeChildChain(address newAddress) returns()
func (_Token *TokenTransactor) ChangeChildChain(opts *bind.TransactOpts, newAddress common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "changeChildChain", newAddress)
}

// ChangeChildChain is a paid mutator transaction binding the contract method 0xed9ef524.
//
// Solidity: function changeChildChain(address newAddress) returns()
func (_Token *TokenSession) ChangeChildChain(newAddress common.Address) (*types.Transaction, error) {
	return _Token.Contract.ChangeChildChain(&_Token.TransactOpts, newAddress)
}

// ChangeChildChain is a paid mutator transaction binding the contract method 0xed9ef524.
//
// Solidity: function changeChildChain(address newAddress) returns()
func (_Token *TokenTransactorSession) ChangeChildChain(newAddress common.Address) (*types.Transaction, error) {
	return _Token.Contract.ChangeChildChain(&_Token.TransactOpts, newAddress)
}
...
// TokenChildChainChangedIterator is returned from FilterChildChainChanged and is used to iterate over the raw logs and unpacked data for ChildChainChanged events raised by the Token contract.
type TokenChildChainChangedIterator struct {
	Event *TokenChildChainChanged // Event containing the contract specifics and raw log
...
func (it *TokenChildChainChangedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenChildChainChanged)
...
func (it *TokenChildChainChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenChildChainChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenChildChainChanged represents a ChildChainChanged event raised by the Token contract.
type TokenChildChainChanged struct {
...
//
// Solidity: event ChildChainChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) FilterChildChainChanged(opts *bind.FilterOpts, previousAddress []common.Address, newAddress []common.Address) (*TokenChildChainChangedIterator, error) {

	var previousAddressRule []interface{}
	for _, previousAddressItem := range previousAddress {
		previousAddressRule = append(previousAddressRule, previousAddressItem)
	}
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "ChildChainChanged", previousAddressRule, newAddressRule)
	if err != nil {
		return nil, err
	}
	return &TokenChildChainChangedIterator{contract: _Token.contract, event: "ChildChainChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ChildChainChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) WatchChildChainChanged(opts *bind.WatchOpts, sink chan<- *TokenChildChainChanged, previousAddress []common.Address, newAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "ChildChainChanged", previousAddressRule, newAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenChildChainChanged)
				if err := _Token.contract.UnpackLog(event, "ChildChainChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseChildChainChanged is a log parse operation binding the contract event 0x1f9f3556dd336016cdf20adaead7d5c73665dba664b60e8c17e9a4eb91ce1d39.
//
// Solidity: event ChildChainChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) ParseChildChainChanged(log types.Log) (*TokenChildChainChanged, error) {
	event := new(TokenChildChainChanged)
	if err := _Token.contract.UnpackLog(event, "ChildChainChanged", log); err != nil {
		return nil, err
	}
...
// TokenParentChangedIterator is returned from FilterParentChanged and is used to iterate over the raw logs and unpacked data for ParentChanged events raised by the Token contract.
type TokenParentChangedIterator struct {
	Event *TokenParentChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenParentChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenParentChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenParentChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenParentChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenParentChanged represents a ParentChanged event raised by the Token contract.
type TokenParentChanged struct {
	PreviousAddress common.Address
	NewAddress      common.Address
	Raw             types.Log // Blockchain specific contextual infos
}

// FilterParentChanged is a free log retrieval operation binding the contract event 0xc9e4c719f349d4c91a37138eb5cf0ba2670c592a764f8c0b18c603ba9178cc1d.
//
// Solidity: event ParentChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) FilterParentChanged(opts *bind.FilterOpts, previousAddress []common.Address, newAddress []common.Address) (*TokenParentChangedIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "ParentChanged", previousAddressRule, newAddressRule)
	if err != nil {
		return nil, err
	}
	return &TokenParentChangedIterator{contract: _Token.contract, event: "ParentChanged", logs: logs, sub: sub}, nil
}

// WatchParentChanged is a free log subscription operation binding the contract event 0xc9e4c719f349d4c91a37138eb5cf0ba2670c592a764f8c0b18c603ba9178cc1d.
//
// Solidity: event ParentChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) WatchParentChanged(opts *bind.WatchOpts, sink chan<- *TokenParentChanged, previousAddress []common.Address, newAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "ParentChanged", previousAddressRule, newAddressRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenParentChanged)
				if err := _Token.contract.UnpackLog(event, "ParentChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseParentChanged is a log parse operation binding the contract event 0xc9e4c719f349d4c91a37138eb5cf0ba2670c592a764f8c0b18c603ba9178cc1d.
//
// Solidity: event ParentChanged(address indexed previousAddress, address indexed newAddress)
func (_Token *TokenFilterer) ParseParentChanged(log types.Log) (*TokenParentChanged, error) {
	event := new(TokenParentChanged)
	if err := _Token.contract.UnpackLog(event, "ParentChanged", log); err != nil {
		return nil, err
	}
